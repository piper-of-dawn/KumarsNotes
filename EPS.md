...
5. **What is Diluted EPS:** “What EPS would be” if all dilutive instruments became common stock. This would be (Actual Earnings / (Ordinary Shares + New common stock that would have been issued at conversion))
...
7. **What is stock split:** Suppose a company with a market capitalisation of $100 has 100 shares (each share is priced $1). The company declares 2:1 stock split, which means each share would be split into 2 shares. This means the number of shares will be now: (100 * (2/1)) = 200. Now each share would be priced $0.5.




9. Complex Capital Structure: 
